...
- [ ] **8.2 — Audio front-end: VAD and noise/gain preprocessing.** Add VAD-based endpointing (Silero VAD recommended) to `features/voice/engine.py`'s capture path, plus basic gain normalization and noise suppression before audio reaches Vosk. No dependency on other items here.
